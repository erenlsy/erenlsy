...
bool operator==(const ::msgs_demo::TriggerResponse_<ContainerAllocator1> & lhs, const ::msgs_demo::TriggerResponse_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::msgs_demo::TriggerResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bool success   # 标示srv是否成功运行\n"
