...
bool operator==(const ::msgs_demo::TalkerListenerRequest_<ContainerAllocator1> & lhs, const ::msgs_demo::TalkerListenerRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::msgs_demo::TalkerListenerRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#这是一个问答类型的srv文件，当一个node发送消息时，另外一个node对接收到\n"
"#的请求做出回应\n"
"\n"
"string request\n"
;
