...
"""autogenerated by genpy from msgs_demo/MoveBaseActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionResult(genpy.Message):
  ...
  _type = "msgs_demo/MoveBaseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','msgs_demo/MoveBaseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveBaseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = msgs_demo.msg.MoveBaseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = msgs_demo.msg.MoveBaseResult()
