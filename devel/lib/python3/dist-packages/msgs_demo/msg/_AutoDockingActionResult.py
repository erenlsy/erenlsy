...
"""autogenerated by genpy from msgs_demo/AutoDockingActionResult.msg. Do not edit."""
import codecs
import sys
...
class AutoDockingActionResult(genpy.Message):
  _md5sum = "3fb2b9cd9cec6b4cb23b224521dd7679"
  _type = "msgs_demo/AutoDockingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','msgs_demo/AutoDockingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutoDockingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = msgs_demo.msg.AutoDockingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = msgs_demo.msg.AutoDockingResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.text = str[start:end]
      return self
