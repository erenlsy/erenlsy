...
"""autogenerated by genpy from msgs_demo/GetMapActionGoal.msg. Do not edit."""
import codecs
import sys
...
class GetMapActionGoal(genpy.Message):
  ...
  _type = "msgs_demo/GetMapActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','msgs_demo/GetMapGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = msgs_demo.msg.GetMapGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = msgs_demo.msg.GetMapGoal()
