...
"""autogenerated by genpy from msgs_demo/AddTwoIntsActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AddTwoIntsActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "msgs_demo/AddTwoIntsActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','msgs_demo/AddTwoIntsFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddTwoIntsActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = msgs_demo.msg.AddTwoIntsFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = msgs_demo.msg.AddTwoIntsFeedback()
