...
"""autogenerated by genpy from msgs_demo/MoveBaseActionGoal.msg. Do not edit."""
import codecs
import sys
...
class MoveBaseActionGoal(genpy.Message):
  ...
  _type = "msgs_demo/MoveBaseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','msgs_demo/MoveBaseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = msgs_demo.msg.MoveBaseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = msgs_demo.msg.MoveBaseGoal()
