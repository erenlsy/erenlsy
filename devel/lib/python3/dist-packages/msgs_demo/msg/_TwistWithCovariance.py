...
"""autogenerated by genpy from msgs_demo/TwistWithCovariance.msg. Do not edit."""
import codecs
import sys
...
class TwistWithCovariance(genpy.Message):
  ...
  _type = "msgs_demo/TwistWithCovariance"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#消息定义了包含不确定性的速度量，协方差矩阵按行分别表示：
...
"""
  ...
  _slot_types = ['msgs_demo/Twist','float64[36]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.twist is None:
        self.twist = msgs_demo.msg.Twist()
