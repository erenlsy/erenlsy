...
"""autogenerated by genpy from msgs_demo/GetMapActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GetMapActionFeedback(genpy.Message):
  ...
  _type = "msgs_demo/GetMapActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','msgs_demo/GetMapFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = msgs_demo.msg.GetMapFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = msgs_demo.msg.GetMapFeedback()
