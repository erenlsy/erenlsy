...
"""autogenerated by genpy from msgs_demo/AddTwoIntsActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddTwoIntsActionResult(genpy.Message):
  _md5sum = "3ba7dea8b8cddcae4528ade4ef74b6e7"
  _type = "msgs_demo/AddTwoIntsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','msgs_demo/AddTwoIntsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddTwoIntsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = msgs_demo.msg.AddTwoIntsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = msgs_demo.msg.AddTwoIntsResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.sum,) = _get_struct_q().unpack(str[start:end])
      return self
