...
"""autogenerated by genpy from msgs_demo/AutoDockingAction.msg. Do not edit."""
import codecs
import sys
...
class AutoDockingAction(genpy.Message):
  _md5sum = "44be114f3afc06365a090db0a5e982b5"
  _type = "msgs_demo/AutoDockingAction"
...
"""
  ...
  _slot_types = ['msgs_demo/AutoDockingActionGoal','msgs_demo/AutoDockingActionResult','msgs_demo/AutoDockingActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AutoDockingAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = msgs_demo.msg.AutoDockingActionGoal()
      if self.action_result is None:
        self.action_result = msgs_demo.msg.AutoDockingActionResult()
      if self.action_feedback is None:
        self.action_feedback = msgs_demo.msg.AutoDockingActionFeedback()
    else:
      self.action_goal = msgs_demo.msg.AutoDockingActionGoal()
      self.action_result = msgs_demo.msg.AutoDockingActionResult()
      self.action_feedback = msgs_demo.msg.AutoDockingActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.text
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_feedback.feedback.text = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.text = str[start:end]
      return self
