...
"""autogenerated by genpy from msgs_demo/SetCameraInfoRequest.msg. Do not edit."""
import codecs
import sys
...
class SetCameraInfoRequest(genpy.Message):
  ...
  _type = "msgs_demo/SetCameraInfoRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#通过给定的CameraInfo相机信息，来对相机进行标定
...
def _get_struct_9d():
    ...
    return _struct_9d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from msgs_demo/SetCameraInfoResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetCameraInfoResponse(genpy.Message):
  ...
  _type = "msgs_demo/SetCameraInfoResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """bool success			#如果调用成功，则返回true
