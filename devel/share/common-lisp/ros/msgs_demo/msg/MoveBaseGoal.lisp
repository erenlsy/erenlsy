...
(cl:defmethod cl:initialize-instance :after ((m <MoveBaseGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveBaseGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-msg:<MoveBaseGoal> is deprecated: use msgs_demo-msg:MoveBaseGoal instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <MoveBaseGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:target_pose-val is deprecated.  Use msgs_demo-msg:target_pose instead.")
  (target_pose m))
