...
(cl:defclass <MoveBaseActionGoal> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (goal
    :reader goal
    :initarg :goal
    :type msgs_demo-msg:MoveBaseGoal
    :initform (cl:make-instance 'msgs_demo-msg:MoveBaseGoal)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveBaseActionGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveBaseActionGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-msg:<MoveBaseActionGoal> is deprecated: use msgs_demo-msg:MoveBaseActionGoal instead.")))
