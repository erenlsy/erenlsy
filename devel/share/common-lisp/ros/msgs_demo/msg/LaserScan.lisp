...
(cl:defmethod cl:initialize-instance :after ((m <LaserScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaserScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-msg:<LaserScan> is deprecated: use msgs_demo-msg:LaserScan instead.")))
...
(cl:defmethod angle_min-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:angle_min-val is deprecated.  Use msgs_demo-msg:angle_min instead.")
  (angle_min m))

(cl:ensure-generic-function 'angle_max-val :lambda-list '(m))
(cl:defmethod angle_max-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:angle_max-val is deprecated.  Use msgs_demo-msg:angle_max instead.")
  (angle_max m))

(cl:ensure-generic-function 'angle_increment-val :lambda-list '(m))
(cl:defmethod angle_increment-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:angle_increment-val is deprecated.  Use msgs_demo-msg:angle_increment instead.")
  (angle_increment m))

(cl:ensure-generic-function 'time_increment-val :lambda-list '(m))
(cl:defmethod time_increment-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:time_increment-val is deprecated.  Use msgs_demo-msg:time_increment instead.")
  (time_increment m))

(cl:ensure-generic-function 'scan_time-val :lambda-list '(m))
(cl:defmethod scan_time-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:scan_time-val is deprecated.  Use msgs_demo-msg:scan_time instead.")
  (scan_time m))

(cl:ensure-generic-function 'range_min-val :lambda-list '(m))
(cl:defmethod range_min-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:range_min-val is deprecated.  Use msgs_demo-msg:range_min instead.")
  (range_min m))

(cl:ensure-generic-function 'range_max-val :lambda-list '(m))
(cl:defmethod range_max-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:range_max-val is deprecated.  Use msgs_demo-msg:range_max instead.")
  (range_max m))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:ranges-val is deprecated.  Use msgs_demo-msg:ranges instead.")
  (ranges m))

(cl:ensure-generic-function 'intensities-val :lambda-list '(m))
(cl:defmethod intensities-val ((m <LaserScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-msg:intensities-val is deprecated.  Use msgs_demo-msg:intensities instead.")
  (intensities m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LaserScan>)))
  ...
  (cl:format cl:nil "#平面内的激光测距扫描数据，注意此消息类型仅仅适配激光测距设备~%#如果有其他类型的测距设备(如声呐)，需要另外创建不同类型的消息~%~%#位置：sensor_msgs/LaserScan.msg~%~%Header header			#时间戳为接收到第一束激光的时间~%float32 angle_min		#扫描开始时的角度(单位为rad)~%float32 angle_max		#扫描结束时的角度(单位为rad)~%float32 angle_increment	#两次测量之间的角度增量(单位为rad)~%~%float32 time_increment	#两次测量之间的时间增量(单位为s)~%~%float32 scan_time		#两次扫描之间的时间间隔(单位为s)~%~%float32 range_min		#距离最小值(m)~%float32 range_max		#距离最大值(m)~%~%float32[] ranges		#测距数据(m,如果数据不在最小数据和最大数据之间，则抛弃)~%~%float32[] intensities	#强度，具体单位由测量设备确定，如果仪器没有强度测量，则数组为空即可~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LaserScan)))
  "Returns full string definition for message of type 'LaserScan"
  (cl:format cl:nil "#平面内的激光测距扫描数据，注意此消息类型仅仅适配激光测距设备~%#如果有其他类型的测距设备(如声呐)，需要另外创建不同类型的消息~%~%#位置：sensor_msgs/LaserScan.msg~%~%Header header			#时间戳为接收到第一束激光的时间~%float32 angle_min		#扫描开始时的角度(单位为rad)~%float32 angle_max		#扫描结束时的角度(单位为rad)~%float32 angle_increment	#两次测量之间的角度增量(单位为rad)~%~%float32 time_increment	#两次测量之间的时间增量(单位为s)~%~%float32 scan_time		#两次扫描之间的时间间隔(单位为s)~%~%float32 range_min		#距离最小值(m)~%float32 range_max		#距离最大值(m)~%~%float32[] ranges		#测距数据(m,如果数据不在最小数据和最大数据之间，则抛弃)~%~%float32[] intensities	#强度，具体单位由测量设备确定，如果仪器没有强度测量，则数组为空即可~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
