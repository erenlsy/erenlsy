...
(cl:defmethod cl:initialize-instance :after ((m <SetMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<SetMap-request> is deprecated: use msgs_demo-srv:SetMap-request instead.")))

(cl:ensure-generic-function 'map-val :lambda-list '(m))
(cl:defmethod map-val ((m <SetMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:map-val is deprecated.  Use msgs_demo-srv:map instead.")
  (map m))

(cl:ensure-generic-function 'initial_pose-val :lambda-list '(m))
(cl:defmethod initial_pose-val ((m <SetMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:initial_pose-val is deprecated.  Use msgs_demo-srv:initial_pose instead.")
  (initial_pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<SetMap-response> is deprecated: use msgs_demo-srv:SetMap-response instead.")))
