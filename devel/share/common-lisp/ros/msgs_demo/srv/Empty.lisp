...
(cl:defmethod cl:initialize-instance :after ((m <Empty-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<Empty-request> is deprecated: use msgs_demo-srv:Empty-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Empty-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<Empty-response> is deprecated: use msgs_demo-srv:Empty-response instead.")))
