...
(cl:defmethod cl:initialize-instance :after ((m <GetPlan-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPlan-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<GetPlan-request> is deprecated: use msgs_demo-srv:GetPlan-request instead.")))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <GetPlan-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:start-val is deprecated.  Use msgs_demo-srv:start instead.")
  (start m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <GetPlan-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:goal-val is deprecated.  Use msgs_demo-srv:goal instead.")
  (goal m))

(cl:ensure-generic-function 'tolerance-val :lambda-list '(m))
(cl:defmethod tolerance-val ((m <GetPlan-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:tolerance-val is deprecated.  Use msgs_demo-srv:tolerance instead.")
  (tolerance m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetPlan-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPlan-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgs_demo-srv:<GetPlan-response> is deprecated: use msgs_demo-srv:GetPlan-response instead.")))

(cl:ensure-generic-function 'plan-val :lambda-list '(m))
(cl:defmethod plan-val ((m <GetPlan-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgs_demo-srv:plan-val is deprecated.  Use msgs_demo-srv:plan instead.")
  (plan m))
