...
if("TRUE" STREQUAL "TRUE")
  set(action_demo_SOURCE_PREFIX /home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/action_demo)
  set(action_demo_DEVEL_PREFIX /home/lsy/catkin_ws/devel)
  ...
  set(action_demo_INSTALL_PREFIX /home/lsy/catkin_ws/install)
...
if(NOT "/home/lsy/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'an <an@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'action_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/action_demo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT action_demo_NUM_DUMMY_TARGETS)
      set(action_demo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::action_demo::wrapped-linker-option${action_demo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR action_demo_NUM_DUMMY_TARGETS "${action_demo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::action_demo::wrapped-linker-option${action_demo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND action_demo_LIBRARIES "${interface_target_name}")
