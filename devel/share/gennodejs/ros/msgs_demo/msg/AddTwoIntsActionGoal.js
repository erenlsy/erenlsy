...
let AddTwoIntsGoal = require('./AddTwoIntsGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class AddTwoIntsActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AddTwoIntsGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddTwoIntsActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = AddTwoIntsGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new AddTwoIntsGoal()
    }
...
module.exports = AddTwoIntsActionGoal;
