...
class MoveBaseActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveBaseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveBaseActionFeedback(null);
    ...
    data.feedback = MoveBaseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveBaseFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveBaseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MoveBaseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MoveBaseFeedback()
    }
...
module.exports = MoveBaseActionFeedback;
