...
class MoveBaseActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveBaseResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveBaseActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MoveBaseResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MoveBaseResult()
    }
...
module.exports = MoveBaseActionResult;
