...
class GetMapActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetMapFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetMapActionFeedback(null);
    ...
    data.feedback = GetMapFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMapActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetMapFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetMapFeedback()
    }
...
module.exports = GetMapActionFeedback;
