...
class AutoDockingActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AutoDockingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AutoDockingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = AutoDockingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new AutoDockingGoal()
    }
...
module.exports = AutoDockingActionGoal;
