...
class GetMapActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetMapResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += GetMapResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMapActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GetMapResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GetMapResult()
    }
