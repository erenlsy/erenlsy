...
let AddTwoIntsFeedback = require('./AddTwoIntsFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class AddTwoIntsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new AddTwoIntsFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AddTwoIntsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AddTwoIntsActionFeedback(null);
    ...
    data.feedback = AddTwoIntsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddTwoIntsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = AddTwoIntsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new AddTwoIntsFeedback()
    }
...
module.exports = AddTwoIntsActionFeedback;
