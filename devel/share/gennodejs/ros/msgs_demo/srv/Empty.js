...
class EmptyRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EmptyRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptyRequest(null);
    return resolved;
    }
};
...
class EmptyResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EmptyResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'msgs_demo/EmptyResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptyResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'msgs_demo/Empty'; }
};
