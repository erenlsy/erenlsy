...
if("TRUE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/dependlib/openslam_gmapping)
  set(openslam_gmapping_DEVEL_PREFIX /home/lsy/catkin_ws/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /home/lsy/catkin_ws/install)
...
if(NOT "/home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/dependlib/openslam_gmapping/include " STREQUAL " ")
  set(openslam_gmapping_INCLUDE_DIRS "")
  set(_include_dirs "/home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/dependlib/openslam_gmapping/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lsy/catkin_ws/src/ROS-Academy-for-Beginners/dependlib/openslam_gmapping/${idir}'.  ${_report}")
    endif()
    _list_append_unique(openslam_gmapping_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "utils;sensor_base;sensor_odometry;sensor_range;log;configfile;scanmatcher;gridfastslam")
...
foreach(depend ${depends})
  ...
  list(APPEND openslam_gmapping_EXPORTED_TARGETS ${${openslam_gmapping_dep}_EXPORTED_TARGETS})
endforeach()
