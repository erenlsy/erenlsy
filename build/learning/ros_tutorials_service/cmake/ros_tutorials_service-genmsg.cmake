...
get_filename_component(_filename "/home/lsy/catkin_ws/src/learning/ros_tutorials_service/srv/SrvTutorial.srv" NAME_WE)
add_custom_target(_ros_tutorials_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_tutorials_service" "/home/lsy/catkin_ws/src/learning/ros_tutorials_service/srv/SrvTutorial.srv" ""
)
...
_generate_srv_cpp(ros_tutorials_service
  "/home/lsy/catkin_ws/src/learning/ros_tutorials_service/srv/SrvTutorial.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ros_tutorials_service\")")
  # install generated code
  install(
